...
<%
	...
	if((session.getAttribute("userName")==null) || (session.getAttribute("currentPage")==null)) {
		...
		String currentPage = "processSyllabusEdition.jsp";
		...
		try {
			...
			if(appDBAuth.verifyUserPageAccess(userName, currentPage)) {
				...
				if(res.next()) {
					...
					session.setAttribute("currentPage", "processSyllabusEdition.jsp");
					...
					String courseTitle =  request.getParameter("course_title").trim();
					String courseType = request.getParameter("course_type").trim();
					String courseModality = request.getParameter("modality").trim();
					String courseLevel = request.getParameter("nivel").trim();
					...
					SyllabusInfo syllabus = new SyllabusInfo(courseCode, courseTitle, courseType, courseModality, courseLevel);
					...
					if(caep.equals("caep")) {
						...
						for(int i=1; i<=amountObjectives; i++) {
							...
							// so the previous information is deleted
						...
						// Insert the ArrayList in the SyllabusInfo object
						...
						if(insertResult == 0) {
							...
							session.setAttribute("errorSyllabusEdition", null);
				            ...
				            <html lang="es">
				              <head>
				                ...
				                <meta http-equiv="Refresh" content="8;url=courseSyllabusPreview.jsp">
				                <style type="text/css">
				                  h1 {
				                      position: relative;
				                      margin-top: 25%;
							...
							session.setAttribute("errorSyllabusEdition", "true");
				            ...
				            <html lang="es">
				              <head>
				                <title>Redireccionando...</title>
				                <meta http-equiv="Refresh" content="8;url=editSyllabus.jsp">
				                <style type="text/css">
				                  h1 {
				                      position: relative;
				                      margin-top: 25%;
			            ...
			            <html lang="es">
			              ...
			              <body>
							<h1 id="error">El encacillado de CAEP no fue seleccionado!</h1>
		          			</body>
				        </html>
		          		<%
					}
