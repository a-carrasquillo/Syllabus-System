...
<%
	...
	if((session.getAttribute("userName")==null) || (session.getAttribute("currentPage")==null)) {
		...
		String currentPage = "searchCourseCode.jsp";
		...
		try {
			...
			if(appDBAuth.verifyUserPageAccess(userName, currentPage)) {
				...
				if(res.next()) {
					...
					session.setAttribute("currentPage", "searchCourseCode.jsp");
					...
					<html lang="es">
					    <head>
					        ...
					        <link rel = "stylesheet" type="text/css" href="css/searchCourseCode.css">
					...
					// Perform the course search in the DB
					res = appDBMnger.searchCourse(search);

					%>
					<div class = "blankpage">
						<h1>Resultados de la B&uacute;squeda de Prontuarios:</h1>
					<%
					...
					if(res.next()) {
						...
						// There is no result
						%>
						<h2>No hay resultados de prontuarios activos para su b&uacute;squeda. Regrese a Home e intente de nuevo.</h2><%
					}
